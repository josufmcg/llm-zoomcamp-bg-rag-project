...
class DocumentInput(BaseModel):
    ...
    question: str
    text: str
    doc_id: str | None = None  # Optional; defaults to lowercase subcategory
...
def ingest_documents(
    ...
    Each document is:
    1. Hashed (MD5 of category + subcategory + question + text) for deduplication.
    2. Skipped if a document with the same hash already exists.
    3. Embedded (question + text combined) using the ONNX model.
        ...
        with conn.cursor() as cur:
            for doc in request.documents:
                doc_hash = compute_doc_hash(
                    doc.category, doc.subcategory, doc.question, doc.text
                )
                ...
                # Determine doc_id
                doc_id = doc.doc_id or doc.subcategory.lower().replace(" ", "_")
